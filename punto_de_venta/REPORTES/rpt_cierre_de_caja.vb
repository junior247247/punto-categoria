...
Public Class rpt_cierre_de_caja
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "punto_de_venta.rpt_cierre_de_caja.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_cierre_de_caja
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_cierre_de_caja = New rpt_cierre_de_caja()
        rpt.Site = Me.Site
        Return rpt
    End Function
