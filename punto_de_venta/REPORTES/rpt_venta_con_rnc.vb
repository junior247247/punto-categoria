...
Public Class rpt_venta_con_rnc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "punto_de_venta.rpt_venta_con_rnc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_venta_con_rnc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_venta_con_rnc = New rpt_venta_con_rnc()
        rpt.Site = Me.Site
        Return rpt
    End Function
