...
Public Class frm_reporte_con_rnc
    Private Sub frm_reporte_con_rnc_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim class_reporte As New class_reporte
        Dim dt As New DataTable
        Dim obj_reporte As New rpt_venta_con_rnc
        Dim data_se As New data_set_reportes

        dt = class_reporte.mostrar_reporte_venta(Val(lbl_id_venta.Text))
        ...
        If dt.Rows.Count > 0 Then
            ...
            For i = 0 To dt.Rows.Count - 1 Step 1
                ...
                Dim dtr_comprobante As DataRow = data_se.Tables("mostrar_reporte_venta").NewRow
                ...
                data_se.Tables("mostrar_reporte_venta").Rows.Add(dtr_comprobante)
