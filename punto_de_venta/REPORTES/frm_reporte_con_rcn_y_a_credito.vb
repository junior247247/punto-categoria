...
Public Class frm_reporte_con_rcn_y_a_credito
    Private Sub frm_reporte_con_rcn_y_a_credito_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        Dim class_reporte As New class_reporte
        Dim dt As New DataTable
        Dim obj_reporte As New rpt_venta_a_credito_con_rnc
